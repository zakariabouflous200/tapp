...
module.exports = {
  name: 'cam-off',
  description: 'Disable camera permission for everyone in the voice channel.',
      ...
      (err, row) => {
        ...
        db.get(
          ...
          (err2, managerRow) => {
            ...
            return message.channel.send({
              embeds: [new EmbedBuilder().setDescription('   You must be the channel owner or a manager to disable the camera.')]
            });
          }
        );
        ...
        async function disableCamera() {
          try {
            ...
            return message.channel.send({
              embeds: [
                new EmbedBuilder().setDescription('<:arcadiacamoff:1401751870430515211>  Camera permission disabled for everyone in this voice channel.')
              ]
            });
          } catch (err) {
